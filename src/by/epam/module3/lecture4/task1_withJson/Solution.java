...
import by.epam.module3.lecture4.json.JsonData;
...
public class Solution {
    public static void main (String... aArguments) throws InvalidWeightException, InvalidCandyTypeException, FileTypeException, IOException {
        ...
        SearchBoxParser parser;
        List<String> tokens = JsonData.getJsonDataFile("src/by/epam/module3/lecture4/json/candies_data.json");
